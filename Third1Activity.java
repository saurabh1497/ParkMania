...
import static com.example.admin.signup.R.id.radioBtn1;
import static com.example.admin.signup.R.id.radioBtn2;
...
public class Third1Activity extends AppCompatActivity {
    ...
    public void addListener(){
        ...
        Proceed = (Button) findViewById(R.id.btn6);
        Proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Wheeler.getId()==radioBtn1){
                    OnProceedToTwoWheeler();
                    AddParkingData();
                }else if(Wheeler.getId()==radioBtn2){
    ...
    private void OnProceedToFourWheeler() {
        ...
        Intent intent = new Intent(getApplicationContext(), NearByCarsActivity.class);
        startActivity(intent);
    } //else {
    // Toast.makeText(getApplicationContext(), "Please select something", Toast.LENGTH_SHORT).show();
    //}
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            case R.id.logoutMenu:{
                ...
                finish();
                Intent intent=new Intent(Third1Activity.this,MainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(intent);
                break;
            }
            case R.id.profileMenu:
                startActivity(new Intent(Third1Activity.this,ViewProfileActivity.class));
                break;
        }
